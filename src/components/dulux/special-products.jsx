  ...
  const primerProducts = [
    {
      ...
      detailsLink: "/dulux/special-prod/dulux-ambiance-velvet-touch-diamond-glo",
      titleLink: "/dulux/special-pro/dulux-ambiance-velvet-touch-diamond-glo",
    },
  ...
  const sidebarMenus = [
    {
      ...
      items: [
        { name: "Overview", link: "/dulux/specialProd" },
        ...
        <div className="flex-1">
          ...
          <nav className="mb-4 text-sm text-gray-600" aria-label="Breadcrumb">
            <ol className="flex space-x-2 items-center">
              ...
              <Link href="/dulux/special-product" className="text-gray-900" aria-current="page">
                Dulux Special Products
              </Link>
            </ol>
