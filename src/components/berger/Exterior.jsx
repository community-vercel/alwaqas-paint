  ...
  const interiorProducts = [
    {
      ...
      detailsLink: "/berger/ext/weathercoat-glow",
      titleLink: "/berger/ext/sweathercoat-glow",
    },
    {
      id: 2,
      ...
      detailsLink: "/berger/ext/vip-weathercoat",
      titleLink: "/berger/ext/vip-weathercoat",
    },
    {
      id: 3,
      title: "Weather Pro",
      ...
      detailsLink: "/berger/ext/weather-pro",
      titleLink: "/berger/ext/weather-pro",
    },
    {
      id: 4,
      ...
      detailsLink: "/berger/ext/weathercoat-exterior-putty",
      titleLink: "/berger/ext/weathercoat-exterior-putty",
    },
    {
      id: 5,
      ...
      detailsLink: "/berger/ext/weathercoat-pure-seal",
      titleLink: "/berger/ext/weathercoat-pure-seal",
    },
  ];
  ...
  const sidebarMenus = [
    {
      title: "Exterior",
      items: [
        { name: "Overview", link: "/berger/exterior" },
        ...
        <div className="flex-1">
          ...
          <nav className="mb-4 text-sm text-gray-600" aria-label="Breadcrumb">
            <ol className="flex space-x-2 items-center">
              ...
              <Link href="/berger/exterior" className="text-gray-900" aria-current="page">
                Berger Exterior
              </Link>
            </ol>
