  ...
  const interiorProducts = [
    {
      ...
      detailsLink: "/berger/wood/sanding-sealer",
      titleLink: "/berger/wood/sanding-sealer",
    },
    {
      id: 2,
      title: "GLOSS LACQUER",
      ...
      detailsLink: "/berger/wood/gloss-lacquer",
      titleLink: "/berger/wood/gloss-lacquer",
    },
    {
      id: 3,
      title: "MATT LACQUER",
      ...
      detailsLink: "/berger/wood/matt-lacquer",
      titleLink: "/berger/wood/matt-lacquert",
    },
    {
      id: 4,
      title: "PU LACQUER",
      ...
      detailsLink: "/berger/wood/pu-lacquer",
      titleLink: "/berger/wood/pu-lacquer",
    },
    {
      id: 5,
      ...
      detailsLink: "/berger/wood/synthetic-clear-varnish",
      titleLink: "/berger/wood/synthetic-clear-varnish",
    },
    {
      id: 6,
      ...
      detailsLink: "/berger/wood/special-thiner",
      titleLink: "/berger/wood/special-thiner",
    },
    {
      id: 7,
      ...
      detailsLink: "/berger/wood/advance-polyurethane-2k-clear",
      titleLink: "/berger/wood/advance-polyurethane-2k-clear",
    },
    {
      id: 8,
      ...
      detailsLink: "/berger/wood/advance-polyurethane-2k-hardner",
      titleLink: "/berger/wood/advance-polyurethane-2k-hardner",
    },
        {
      id: 9,
      ...
      detailsLink: "/berger/wood/advance-polyurethane-2k-matt-clear",
      titleLink: "/berger/wood/advance-polyurethane-2k-matt-clear",
    },
      ...
      detailsLink: "/berger/wood/advance-polyurethane-2k-sanding-sealer",
      titleLink: "/berger/wood/advance-polyurethane-2k-sanding-sealer",
    },
      ...
      detailsLink: "/berger/wood/advance-polyurethane-2k-thinner",
      titleLink: "/berger/wood/advance-polyurethane-2k-thinner",
    },
  ...
  const sidebarMenus = [
    {
      title: "WoodPro",
      items: [
        { name: "Overview", link: "/berger/wood-pro-range" },
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-64 flex-shrink-0">
          <div className="bg-white rounded-lg shadow-md p-4 sticky top-8">
            <h3 className="text-lg font-bold text-gray-900 mb-4 pb-2 border-b border-gray-200">WoodPro Range</h3>
        ...
        <div className="flex-1">
          ...
          <nav className="mb-4 text-sm text-gray-600" aria-label="Breadcrumb">
            <ol className="flex space-x-2 items-center">
              ...
              <Link href="/berger/wood-pro-range" className="text-gray-900" aria-current="page">
                Berger WoodPro
              </Link>
            </ol>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Wood Pro Range</h2>
