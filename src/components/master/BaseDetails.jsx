...
const MBaseDetailsPage = ({ product }) => {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <nav className="mb-6 text-sm text-gray-500" aria-label="breadcrumb">
          <ol className="flex space-x-3 items-center">
            ...
            <li>
              <Link href="/master/interior" className="hover:text-blue-600 transition-colors font-medium">
                Master
              </Link>
            </li>
            <li className="flex items-center">
...
<div className="mt-8">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 font-semibold">
    ...
    >
      ...
      <span className="text-gray-800 font-semibold text-sm ">Data Sheet</span>
    </a>
    <a
      href={product.downloads?.sc || "#"}
      className="flex items-center p-3 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors"
      target="_blank"
      rel="noopener noreferrer"
    >
      ...
      <span className="text-black font-semibold text-sm">Shade Card </span>
    </a>
...
export default MBaseDetailsPage;