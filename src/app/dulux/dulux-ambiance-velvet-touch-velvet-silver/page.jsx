...
const whatsappConfig = {
  imageVersion: "1.0",
  baseImageUrl: "https://www.alwaqaspaint.com/dulux/22.png",
  imageWidth: 1200,
  imageHeight: 630
};
...
const pageUrl = 'https://www.alwaqaspaint.com/dulux/dulux-ambiance-velvet-touch-velvet-silver';

export const metadata = {
  title: "Dulux Ambiance Velvet Touch Silk Silver",
  ...
  openGraph: {
    title: "Dulux Ambiance Velvet Touch Silk Silver",
    description: "Special effects interior paint with a luxurious fabric finish in silk silver, ideal for creating timeless and trendy wall aesthetics.",
    url: pageUrl,
    type: "website",
    images: [
      {
        ...
        alt: "Dulux Ambiance Velvet Touch Silk Silver Product",
        type: "image/png",
      },
    ],
  ...
  twitter: {
    ...
    title: "Dulux Ambiance Velvet Touch Silk Silver | Alwaqas Paint",
    description: "Premium interior paint with a silk silver fabric finish, offering a luxurious and stylish aesthetic for interior walls.",
  ...
  other: {
    ...
    "og:image:alt": "Dulux Ambiance Velvet Touch Silk Silver Product",
  }
};
