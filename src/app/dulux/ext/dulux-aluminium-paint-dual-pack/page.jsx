...
const whatsappConfig = {
  imageVersion: "1.0",
  baseImageUrl: "https://www.alwaqaspaint.com/dulux/exterior/9.png",
  imageWidth: 1200,
  imageHeight: 630
};
...
const pageUrl = 'https://www.alwaqaspaint.com/dulux/ext/dulux-aluminium-paint-dual-pack';

export const metadata = {
  title: "Dulux Aluminium Paint Dual Pack",
  description: "High-performance silver paint with metallic luster, offering protection against corrosion, discoloration, and heat.",
  ...
  openGraph: {
    title: "Dulux Aluminium Paint Dual Pack",
    description: "Glossy silver paint with anti-rust properties, designed to protect surfaces from corrosion and heat with a high metallic luster.",
    url: pageUrl,
    type: "website",
    images: [
      {
  ...
  twitter: {
    ...
    description: "Silver paint with a glossy finish, providing anti-rust protection and durability for exterior surfaces.",
